                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <form class="form form-vertical" action="{{route('admin.service.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Icon</label><br>
                                                        @if($data->icon)
                                                        <img src="{{ asset($data->icon) }}" style="width:100px" alt="">
                                                        @endif

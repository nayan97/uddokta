                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="contact-info-vertical" class="form-control" name="client">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Company</label>
                                                        <input type="text" id="contact-info-vertical" class="form-control" name="company">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Location</label>
                                                        <input type="text" id="contact-info-vertical" class="form-control" name="location">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Project Type</label>
                                                        <input type="text" id="contact-info-vertical" class="form-control" name="project_type">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Duration</label>
                                                        <input type="text" id="contact-info-vertical" class="form-control" name="duration">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">

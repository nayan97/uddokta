                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a>Newsletter</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form form-vertical" action="{{route('admin.newsletter.submit')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="email[]" id="" class="form-control select2" multiple>

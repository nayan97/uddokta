                                    ...
                                    <form class="form form-vertical" action="{{route('admin.sitesetting.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Icon Light</label>
                                                        @if(!empty($data->icon_light))
                                                        <img src="{{ asset($data->icon_light) }}" style="width:80px;height:80px;margin-top:5px;margin-bottom:5px" alt="">
                                                        @endif
                                                        <input type="file" id="contact-info-vertical" class="form-control" name="icon_light">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Icon Dark</label>
                                                        @if(!empty($data->icon_dark))
                                                        <img src="{{ asset($data->icon_dark) }}" style="width:80px;height:80px;margin-top:5px;margin-bottom:5px" alt="">
                                                        @endif
                                                        <input type="file" id="contact-info-vertical" class="form-control" name="icon_dark">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">

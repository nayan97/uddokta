                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('admin.team.index')}}">Team</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <form class="form form-vertical" action="{{route('admin.team.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="password-vertical">Facebook</label>
                                                        <input type="text" class="form-control" name="facebook" value="{{ $data->facebook }}">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="password-vertical">Twitter</label>
                                                        <input type="text" class="form-control" name="twitter" value="{{ $data->twitter }}">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="password-vertical">linkedin</label>
                                                        <input type="text" class="form-control" name="linkedin" value="{{ $data->linkedin }}">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="password-vertical">Instragram</label>
                                                        <input type="text" class="form-control" name="instragram" value="{{ $data->instragram }}">
                                                    </div>
                                                </div>
